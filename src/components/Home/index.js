      ...
      <div className="title">
        ...
        <section>
          <p className="content">
            ...
            . Every developer must use this for best coding experience with
            syntax highlighting, live code autocompletion, standard code
      ...
      <hr />
          ...
          <div className="content-wrapper">
            ...
            <div className="written-wrapper">
              <p className="content">
                ...
                multiple files. You can access it in <strong>Files</strong> tab
                in sidebar. All you have to do is just enter the file name and
                click on <strong>&#10004;</strong> symbol, our system will
                detect your programming language and will enable corresponding
                snippets for you. You must enter appropriate extension, our
                system will use this extension only to detect language. If our
                system failed to detect it, it will consider your file as plain
                text file.
              </p>
              <p className="content">
                You can rename, delete or download your file easily. Just click
                on <strong>setting</strong> symbol next to the file name, and
                the pop up will be shown to do all this tasks.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="editor-customizations">
          ...
          <div className="content-wrapper reverse">
            ...
            <div className="written-wrapper">
              <p className="content">
                You can easily customize the defalt behaviour of our editor.
                Just visit the <strong>Settings</strong> tab. You can change
                font size, tab size as per your comfort. we have provided lot of
                settings to you. Just play with it to come up with best suitable
      ...
      <hr />
        <section id="themes">
          ...
          <div className="content-wrapper reverse">
            ...
            <div className="written-wrapper">
              <p className="content">
                Are you a night owl or an early bird? Actually its doesn't
                matter for us. We welcome both of them. How? Just check Themes
                tab. Surprised? You have to. We have collection of 35+ Themes so
                that you will never get boared of them. Use different everyday
                and still you will need more than a month to use each of them.
                So, start using from today itself.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="content-wrapper reverse">
            ...
            <div className="written-wrapper">
              <p className="content">
                ...
                you guessed it correctly. You can execute 8 different
                programming languages right here in this editor. This languages
                are C, C++, C#, Java, Kotlin, Python, Ruby, Swift. We guess that
                most of the beginners starts there journey with one of this
                languages. They can use our editor to execute there code
                instantly.
              </p>
            </div>
          </div>
          ...
          <div className="content-wrapper">
            <ol>
              ...
              <li>
                ...
                code online. Thanks to CodeX, we can provide code execution for
                8 languages because of it. CodeX is developed by{" "}
                <a
